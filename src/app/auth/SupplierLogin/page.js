  ...
  return (
    <div className="bg-[#FFFFFF] flex flex-col sm:flex-row min-h-screen sm:h-[70vh]">
      ...
      <div className="w-full sm:w-2/3 flex flex-col justify-center items-center sm:items-start px-6 sm:ml-14 mt-10 sm:mt-0">
        ...
        <div className="flex items-center gap-3 text-sm mt-2 w-full sm:w-2/4 flex-wrap justify-between">
          <label className="flex items-center text-[16px] sm:text-[20px] text-[#000000] font-medium">
            <input
              type="checkbox"
          ...
          <Link
            className="text-[var(--primary-blue)] hover:underline font-medium text-sm sm:text-[16px]"
        ...
        {/* Register */}
        <div className="text-base sm:text-xl mt-6 text-[#000000] font-medium w-full sm:w-2/4">
        ...
        <button
          ...
          className="w-full sm:w-1/4 bg-[var(--primary-blue)] text-white py-2 font-semibold text-base sm:text-lg transition-all rounded-[35px] mt-10 cursor-pointer"
        >
          Login
        </button>
      </div>
