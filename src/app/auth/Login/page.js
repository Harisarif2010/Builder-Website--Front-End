  ...
  return (
    <div className="bg-[#FFFFFF]  flex flex-row h-[70vh]">
      <div className="w-1/2  relative rounded-r-[18px]  ">
        ...
        <div className="absolute inset-0 bg-[#354EF3] mix-blend-multiply opacity-80 pointer-events-none rounded-r-[18px]"></div>
      </div>
      ...
      <div className="w-2/3 flex flex-col ml-14 justify-start mt-10">
        ...
        <button
          type="submit"
          className="w-1/4 bg-[#354EF3] text-white py-2 font-semibold text-lg hover:bg-[#c99f7a] transition-all rounded-[35px] mt-10 cursor-pointer"
