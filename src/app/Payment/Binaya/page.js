    ...
    <div>
      <div className="grid gap-x-4 sm:gap-x-5 gap-y-5 sm:gap-y-6 grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 p-3">
        ...
        <textarea
          ...
          rows={6}
          className="w-full px-4 py-2 h-60 border border-[#6A6A6A] rounded-[22px] focus:outline-none focus:ring-2 focus:ring-gray-200 placeholder-[#787878] placeholder:text-xl sm:placeholder:text-2xl"
          required
        />
      </div>
